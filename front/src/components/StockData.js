...
const stockData = {
  ...
  MS: { name: 'MS', price: '$58,599', change: '-12.2%', symbol: 'down', logo: MSImage },
  ...
  TSLA: { name: 'TSLA', price: '$60,133', change: '+6.6%', symbol: 'up', logo: TSLAImage },
  BROADCOM: { name: 'Broadcom', price: '$1,265,547', change: '+1.1%', symbol: 'up', logo: BroadcomImage },
